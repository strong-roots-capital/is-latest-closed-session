...
*Defined in [is-latest-closed-session.ts:23](https://github.com/strong-roots-capital/is-latest-closed-session/blob/d8b7c54/src/is-latest-closed-session.ts#L23)*
